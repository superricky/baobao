class Backend::AgentsController < BackendApplicationController
  ...
  private
    ...
    def agent_params
      params.require(:agent).permit(:aid, :name, :phone, :balance, agent_rels_attributes: [:id, :agent_id, :agent_from, :agent_to, :agent_zone_id, :_destroy])
    end
end
